...
public class SearchManager {
	...
	/**
	 * Cosntructor initialises string searchValue.
	 * 
	 * @param searchValue
	 */
	...
	/*
	 * Searches User in table of users, considering that searchValue is userName
	 */
	private void searchUserByUserName(String searchValue) {
		...
		try {
			...
			ResultSet rs = preparedStatement.executeQuery();
			while (rs.next()) {
				String username = rs.getString(DBInfo.USERS_USERNAME);
				String password = rs.getString(DBInfo.USERS_PASSWORD);
				String firstName = rs.getString(DBInfo.USERS_FIRSTNAME);
				String lastName = rs.getString(DBInfo.USERS_FIRSTNAME);
				String email = rs.getString(DBInfo.USERS_EMAIL);
				int typeID = rs.getInt(DBInfo.USERS_TYPE_ID);
	...
	/*
	 * Searches User in table of users, considering that searchValue is
	 * FirstName
	 */
	...
	/*
	 * Searches User in table of users, considering that searchValue is LastName
	 */
