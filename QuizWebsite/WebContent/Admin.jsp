...
<body>
	...
	<br>
	<textarea rows="4" cols="50" id="announcement" placeholder="Enter announcement text here..."></textarea>
	<button  onclick='addAnnouncement()'>Add Announcement</button>
	<br>
	
	<br>
	<input type="text" id="removeAccount" placeholder="Enter username here...">
	<button onclick='removeAccount()'>Remove Account</button>
	<br>
	
	<br>
	<input type="text" id="removeQuiz" placeholder="Enter quiz name here...">
	...
	<p>Number of accounts: <%=acm.getNumberOfaccounts() %></p>
	<p>Number of quizzes: <%=qm.getNumberOfQuizzes() %></p>
	
	<script>
	function addAnnouncement(){
		$.post("AdminServlet", {text : document.getElementById("announcement").value, orderNum: 1}, function(data){
			alert(data);
		});
	}
	
	function removeAccount(){
		$.post("AdminServlet", {username : document.getElementById("removeAccount").value, orderNum: 2}, function(data){
			alert(data);
		});
	}
	
	function removeQuiz(){
		$.post("AdminServlet", {quizName : document.getElementById("removeQuiz").value, orderNum: 3}, function(data){
			alert(data);
		});
	}
	
	function promote(){
		$.post("AdminServlet", {username : document.getElementById("promote").value, orderNum: 4}, function(data){
			alert(data);
		});
	}
