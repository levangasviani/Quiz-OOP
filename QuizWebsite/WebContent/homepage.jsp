...
<%
	...
	AnnouncementManager anm = (AnnouncementManager) this.getServletContext()
			.getAttribute(WebSiteInfo.ANNOUNCEMENT_ATTR);
%>
...
<body>
	...
	<div id="announcements">
		<p id="announcement-title">
			Announcements <i class="fa fa-bullhorn"></i>
		</p>
		<%
			if (username != null && anm != null) {
				...
				while (rs.next()) {
					...
					out.print(
							"<div id='announcementStyle' name='announce' style='overflow-y: scroll; border: 0px green solid'>");
